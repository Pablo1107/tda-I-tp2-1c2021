...
\label{sec:org0f5e7f5}

\subsection{Algoritmos Greedy}
\label{sec:org5abe74f}
...
\begin{center}
\includesvg[width=.9\linewidth]{assets/grafo-correcion}
\end{center}
